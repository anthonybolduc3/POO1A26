...
public class Exemple5 {
    ...
    public static void main(String[] args) {
        System.out.println("Exécution du main de la classe Exemple4");

        //instanciation de la classe Exemple5, encore un peu mystérieux?
        Exemple5 programme = new Exemple5();

        //Appel de la méthode afficherBonjourLeMonde sur l'objet appelé programme
    ...
    public void afficher1Plus1() {
        //Afficher une ligne blanche à l'écran
        System.out.println();
